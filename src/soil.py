...
class Plant(pygame.sprite.Sprite):
    def __init__(self, plant_type, groups, soil, check_watered):
        ...
        self.y_offset_V2 = pygame.math.Vector2(0,self.y_offset)
        self.rect = self.image.get_rect(midbottom = soil.rect.midbottom + self.y_offset_V2)
    ...
    def grow(self):
        if self.check_watered(self.rect.center):
            ...
            self.rect = self.image.get_rect(midbottom = self.soil.rect.midbottom + self.y_offset_V2)
...
class SoilLayer:
    def __init__(self, all_sprites, collision_sprites):
        ...
        #graphics
        self.soil_surface = import_folder_dict('../graphics/soil/')
        self.water_surface = import_folder('../graphics/soil_water')
    ...
    def water(self, target_pos):
        for soil_sprite in self.soil_sprites.sprites():
            if soil_sprite.rect.collidepoint(target_pos):
                ...
                surface = choice(self.water_surface)
        ...
        for index_row, row in enumerate(self.grid):
            for index_col, cell in enumerate(row):
                if 'X' in cell and 'W' not in cell:
                    ...
                    x = index_col * TILE_SIZE
                    y = index_row * TILE_SIZE
                    WaterTile((x,y), choice(self.water_surface), [self.all_sprites, self.water_sprites])
            ...
            for index_col, cell in enumerate(row):
                if 'X' in cell:
                    ...
                    SoilTile(pos = (index_col*TILE_SIZE, index_row*TILE_SIZE), 
                             surface = self.soil_surface[tile_type], 
